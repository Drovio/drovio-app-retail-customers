...
if (engine::isPost())
{
	...
	$companyTaxID = $_POST['taxid'];
	if (!empty($companyTaxID) && empty($companyName))
	{
		// Get company info from vies
		$companyInfo = viesManager::getCompanyInfo($companyTaxID);
	...
	$customer->updateCompanyInfo($isCompany, $companyName, $companyTaxID, $_POST['irs']);
